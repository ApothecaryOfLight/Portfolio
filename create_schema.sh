...
echo "CREATE TABLE blog_posts( title MEDIUMTEXT, timestamp TIMESTAMP, body LONGTEXT, post_id INT NOT NULL, PRIMARY KEY(post_id), series_id INT DEFAULT NULL, postorder SMALLINT DEFAULT NULL );" >> "create_schema.sql"
echo "CREATE TABLE blog_images( image_id INT, PRIMARY KEY(image_id), image_data MEDIUMTEXT, series_title MEDIUMTEXT DEFAULT NULL, alt_text TEXT, optional_link TEXT, post_id INT NOT NULL, FOREIGN KEY (post_id) REFERENCES blog_posts(post_id) ON DELETE CASCADE, local_image_id SMALLINT NOT NULL, post_section SMALLINT );" >> "create_schema.sql"
echo "CREATE TABLE portfolio_entries( portfolio_entry_id INT, PRIMARY KEY(portfolio_entry_id), portfolio_title TEXT, portfolio_text MEDIUMTEXT, portfolio_flags MEDIUMTEXT, github_link TEXT, live_page TEXT, dev_page TEXT );" >> "create_schema.sql"
